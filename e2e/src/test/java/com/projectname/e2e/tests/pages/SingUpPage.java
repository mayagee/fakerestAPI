...
public class SingUpPage extends PageBase {
    public SingUpPage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()){
            ...
            navigationBarPage.openSingUpPage();
        }
    ...
    private WebElement getInputFirstNameField() {
        try {
            ...
            e.printStackTrace();
            throw new AssertionError("Could not find input first name on SingUp page", e);
        }
    }
